...
function realActivate(context) {
  ...
  const serverOptions = {
    run: {module: serverModule, transport: import_coc3.TransportKind.ipc, runtime, options: {cwd: import_coc3.workspace.cwd, env}},
    debug: {module: serverModule, transport: import_coc3.TransportKind.ipc, runtime, options: {execArgv: ["--nolazy", "--inspect=6011"], cwd: process.cwd(), env}}
  };
