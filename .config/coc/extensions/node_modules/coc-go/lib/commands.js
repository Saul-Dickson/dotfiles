...
exports.installImpl = exports.installGoplay = exports.installGotests = exports.installGomodifytags = exports.checkGopls = exports.installGopls = exports.version = void 0;
...
async function checkGopls(client, mode) {
    ...
    try {
        ...
        switch (versions_1.compareVersions(latest, current)) {
            case 0:
                coc_nvim_1.workspace.showMessage(`[gopls] up-to-date: ${current}`);
                break;
            case 1:
                switch (mode) {
                    case 'install':
                ...
                break;
            case -1:
                coc_nvim_1.workspace.showMessage(`[gopls] current: ${current} | latest: ${latest}`);
                break;
        }
        if (install) {
        ...
        coc_nvim_1.workspace.showMessage(e.toString());
    }
}
