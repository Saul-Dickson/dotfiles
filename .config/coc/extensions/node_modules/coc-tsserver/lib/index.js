...
const moduleInstall_1 = __importDefault(__webpack_require__(100));
...
const watchBuild_1 = __importDefault(__webpack_require__(112));
const workspaceSymbols_1 = __importDefault(__webpack_require__(113));
const organizeImports_1 = __webpack_require__(114);
...
class LanguageProvider {
    ...
    registerProviders(client, typingsStatus) {
        ...
        if (this.description.id == 'typescript') {
            this.disposables.push(coc_nvim_1.languages.registerWorkspaceSymbolProvider(new workspaceSymbols_1.default(client, languageIds)));
        }
...
const coc_nvim_1 = __webpack_require__(1);
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const modules_1 = __webpack_require__(101);
...
const fileConfigurationManager_1 = __importDefault(__webpack_require__(93));
const requestQueue_1 = __webpack_require__(125);
const typescriptService_1 = __webpack_require__(120);
const api_1 = __importDefault(__webpack_require__(40));
const configuration_1 = __webpack_require__(126);
const logger_1 = __importDefault(__webpack_require__(131));
const process_1 = __webpack_require__(133);
const tracer_1 = __importDefault(__webpack_require__(134));
const tsconfig_1 = __webpack_require__(135);
const versionProvider_1 = __webpack_require__(136);
const versionStatus_1 = __importDefault(__webpack_require__(137));
const wireProtocol_1 = __webpack_require__(138);
...
const coc_nvim_1 = __webpack_require__(1);
const which_1 = __importDefault(__webpack_require__(127));
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const is = __importStar(__webpack_require__(132));
class Logger {
    get output() {
        if (this._channel) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
const child_process_1 = __importDefault(__webpack_require__(102));
