...
const languageDescription_1 = __webpack_require__(141);
...
const coc_nvim_1 = __webpack_require__(1);
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const arrays_1 = __webpack_require__(34);
const fileConfigurationManager_1 = __importDefault(__webpack_require__(35));
const watchBuild_1 = __importDefault(__webpack_require__(80));
const workspaceSymbols_1 = __importDefault(__webpack_require__(81));
const languageProvider_1 = __importDefault(__webpack_require__(83));
const PConst = __importStar(__webpack_require__(87));
const typescriptServiceClient_1 = __importDefault(__webpack_require__(117));
const typeConverters = __importStar(__webpack_require__(82));
const typingsStatus_1 = __importStar(__webpack_require__(140));
...
const coc_nvim_1 = __webpack_require__(1);
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const api_1 = __importDefault(__webpack_require__(36));
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
const semver = __importStar(__webpack_require__(37));
class API {
...
const internalRe = __webpack_require__(38)
module.exports = {
  re: internalRe.re,
  src: internalRe.src,
  tokens: internalRe.t,
  SEMVER_SPEC_VERSION: __webpack_require__(39).SEMVER_SPEC_VERSION,
  SemVer: __webpack_require__(41),
  compareIdentifiers: __webpack_require__(42).compareIdentifiers,
  rcompareIdentifiers: __webpack_require__(42).rcompareIdentifiers,
  parse: __webpack_require__(43),
  valid: __webpack_require__(44),
  clean: __webpack_require__(45),
  inc: __webpack_require__(46),
  diff: __webpack_require__(47),
  major: __webpack_require__(50),
  minor: __webpack_require__(51),
  patch: __webpack_require__(52),
  prerelease: __webpack_require__(53),
  compare: __webpack_require__(49),
  rcompare: __webpack_require__(54),
  compareLoose: __webpack_require__(55),
  compareBuild: __webpack_require__(56),
  sort: __webpack_require__(57),
  rsort: __webpack_require__(58),
  gt: __webpack_require__(59),
  lt: __webpack_require__(60),
  eq: __webpack_require__(48),
  neq: __webpack_require__(61),
  gte: __webpack_require__(62),
  lte: __webpack_require__(63),
  cmp: __webpack_require__(64),
  coerce: __webpack_require__(65),
  Comparator: __webpack_require__(66),
  Range: __webpack_require__(67),
  satisfies: __webpack_require__(68),
  toComparators: __webpack_require__(69),
  maxSatisfying: __webpack_require__(70),
  minSatisfying: __webpack_require__(71),
  minVersion: __webpack_require__(72),
  validRange: __webpack_require__(73),
  outside: __webpack_require__(74),
  gtr: __webpack_require__(75),
  ltr: __webpack_require__(76),
  intersects: __webpack_require__(77),
  simplifyRange: __webpack_require__(78),
  subset: __webpack_require__(79),
}
...
const { MAX_SAFE_COMPONENT_LENGTH } = __webpack_require__(39)
...
const { re, t } = __webpack_require__(38)

const { compareIdentifiers } = __webpack_require__(42)
class SemVer {
...
const {MAX_LENGTH} = __webpack_require__(39)
const { re, t } = __webpack_require__(38)
...
const parse = __webpack_require__(43)
const eq = __webpack_require__(48)
...
const compare = __webpack_require__(49)
...
const compareBuild = __webpack_require__(56)
...
const eq = __webpack_require__(48)
const neq = __webpack_require__(61)
const gt = __webpack_require__(59)
const gte = __webpack_require__(62)
const lt = __webpack_require__(60)
const lte = __webpack_require__(63)
...
const {re, t} = __webpack_require__(38)
const cmp = __webpack_require__(64)
const debug = __webpack_require__(40)
const SemVer = __webpack_require__(41)
...
const Comparator = __webpack_require__(66)
const debug = __webpack_require__(40)
const SemVer = __webpack_require__(41)
const {
  re,
...
const Range = __webpack_require__(67)
const satisfies = __webpack_require__(68)
const gt = __webpack_require__(59)
const lt = __webpack_require__(60)
const lte = __webpack_require__(63)
const gte = __webpack_require__(62)
...
const outside = __webpack_require__(74)
...
const Range = __webpack_require__(67)
const { ANY } = __webpack_require__(66)
const satisfies = __webpack_require__(68)
const compare = __webpack_require__(49)
...
class WatchProject {
    constructor(client) {
        ...
        task.onExit(code => {
            if (code != 0) {
                coc_nvim_1.window.showMessage(`TSC exit with code ${code}`, 'warning');
            }
            this.onStop();
        });
        task.onStdout(lines => {
    ...
    async getOptions() {
        ...
        if (!tscPath) {
            coc_nvim_1.window.showMessage(`Local & global tsc not found`, 'error');
            return;
        }
        let find = await coc_nvim_1.workspace.findUp(['tsconfig.json']);
        if (!find) {
            coc_nvim_1.window.showMessage('tsconfig.json not found!', 'error');
            return;
        }
...
const path_1 = __importDefault(__webpack_require__(13));
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const baseCodeLensProvider_1 = __webpack_require__(84);
const completionItemProvider_1 = __importDefault(__webpack_require__(86));
const definitionProvider_1 = __importDefault(__webpack_require__(92));
const directiveCommentCompletions_1 = __importDefault(__webpack_require__(93));
const documentHighlight_1 = __importDefault(__webpack_require__(94));
const documentSymbol_1 = __importDefault(__webpack_require__(95));
const folding_1 = __importDefault(__webpack_require__(96));
const formatting_1 = __importDefault(__webpack_require__(97));
const hover_1 = __importDefault(__webpack_require__(98));
const implementationsCodeLens_1 = __importDefault(__webpack_require__(99));
const importFix_1 = __importDefault(__webpack_require__(100));
const moduleInstall_1 = __importDefault(__webpack_require__(102));
// import TagCompletionProvider from './features/tagCompletion'
const quickfix_1 = __importDefault(__webpack_require__(106));
const refactor_1 = __importDefault(__webpack_require__(108));
const references_1 = __importDefault(__webpack_require__(109));
const referencesCodeLens_1 = __importDefault(__webpack_require__(110));
const rename_1 = __importDefault(__webpack_require__(111));
const signatureHelp_1 = __importDefault(__webpack_require__(112));
const smartSelect_1 = __importDefault(__webpack_require__(113));
const updatePathOnRename_1 = __importDefault(__webpack_require__(114));
const organizeImports_1 = __webpack_require__(116);
const api_1 = __importDefault(__webpack_require__(36));
...
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const regexp_1 = __webpack_require__(85);
const typeConverters = __importStar(__webpack_require__(82));
...
const completionItem_1 = __webpack_require__(89);
const Previewer = __importStar(__webpack_require__(90));
const SnippetString_1 = __importDefault(__webpack_require__(91));
const typeConverters = __importStar(__webpack_require__(82));
class ApplyCompletionCodeActionCommand {
    ...
    async execute(codeActions) {
        ...
        const idx = await coc_nvim_1.window.showQuickpick(codeActions.map(o => o.description), 'Select code action to apply');
        if (idx < 0)
            return;
...
class TypeScriptCompletionItemProvider {
    constructor(client, typingsStatus, fileConfigurationManager, languageId) {
        ...
        coc_nvim_1.commands.registerCommand(ApplyCompletionCodeActionCommand.ID, async (codeActions) => {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const previewer_1 = __webpack_require__(90);
const typeConverters = __importStar(__webpack_require__(82));
...
const coc_nvim_1 = __webpack_require__(1);
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const helper_1 = __webpack_require__(101);
...
const coc_nvim_1 = __webpack_require__(1);
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const modules_1 = __webpack_require__(103);
class InstallModuleProvider {
    constructor(client) {
        this.client = client;
        coc_nvim_1.commands.registerCommand('_tsserver.installModule', async (uri, name) => {
...
const coc_nvim_1 = __webpack_require__(1);
const fs_1 = __importDefault(__webpack_require__(105));
const path_1 = __importDefault(__webpack_require__(13));
...
async function installModules(uri, names) {
    ...
    if (!root || !fs_1.default.existsSync(path_1.default.join(root, 'package.json'))) {
        coc_nvim_1.window.showMessage(`package.json not found from workspaceFolder: ${root}`, 'error');
        return;
    }
    let arr = names.concat(names.map(s => `@types/${s}`));
    let statusItem = coc_nvim_1.window.createStatusBarItem(99, { progress: true });
    ...
    try {
        ...
        statusItem.dispose();
        coc_nvim_1.window.showMessage(`Install error ${e.message}`, 'error');
        return;
    }
    statusItem.dispose();
    coc_nvim_1.window.showMessage(`Installed: ${exists.join(' ')}`, 'more');
}
...
class TypeScriptQuickFixProvider {
    constructor(client, formattingConfigurationManager) {
        this.client = client;
        this.formattingConfigurationManager = formattingConfigurationManager;
        commands_1.registCommand(new ApplyCodeActionCommand(client, formattingConfigurationManager));
        commands_1.registCommand(new ApplyFixAllCodeAction(client, formattingConfigurationManager));
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.registCommand = exports.ConfigurePluginCommand = exports.AutoFixCommand = exports.TypeScriptGoToProjectConfigCommand = exports.OpenTsServerLogCommand = exports.ReloadProjectsCommand = void 0;
const coc_nvim_1 = __webpack_require__(1);
const vscode_languageserver_types_1 = __webpack_require__(18);
const helper_1 = __webpack_require__(101);
const modules_1 = __webpack_require__(103);
...
class ReloadProjectsCommand {
    ...
    async execute() {
        ...
        coc_nvim_1.window.showMessage('projects reloaded');
    }
}
...
async function goToProjectConfig(clientHost, uri) {
    ...
    let res;
    try {
        res = await client.execute('projectInfo', { file, needFileNameList: false }, coc_nvim_1.CancellationToken.None);
    }
    catch (_a) {
        // noop
    }
    if (!res || !res.body) {
        coc_nvim_1.window.showMessage('Could not determine TypeScript or JavaScript project.', 'warning');
        return;
    }
    ...
    coc_nvim_1.window.showMessage('Config file not found', 'warning');
}
...
class AutoFixCommand {
    ...
    async execute() {
        ...
        let diagnostics = coc_nvim_1.diagnosticManager.getDiagnostics(document.uri).slice();
        ...
        for (let diagnostic of diagnostics) {
            const args = Object.assign(Object.assign({}, typeConverters.Range.toFileRangeRequestArgs(file, diagnostic.range)), { errorCodes: [+(diagnostic.code)] });
            const response = await client.serviceClient.execute('getCodeFixes', args, coc_nvim_1.CancellationToken.None);
...
function registCommand(cmd) {
    let { id, execute } = cmd;
    return coc_nvim_1.commands.registerCommand(id, execute, cmd);
}
exports.registCommand = registCommand;
...
class SelectRefactorCommand {
    ...
    async execute(document, file, info, range) {
        let { actions } = info;
        const idx = actions.length == 1 ? 0 : await coc_nvim_1.window.showQuickpick(actions.map(action => action.description || action.name));
        if (idx == -1)
            return false;
...
class TypeScriptRefactorProvider {
    constructor(client, formattingOptionsManager) {
        ...
        commands_1.registCommand(doRefactoringCommand);
        commands_1.registCommand(new SelectRefactorCommand(doRefactoringCommand));
    }
...
class TypeScriptSignatureHelpProvider {
    ...
    convertSignature(item) {
        ...
        return {
            label,
            documentation: Previewer.markdownDocumentation(item.documentation, (_a = item.tags) === null || _a === void 0 ? void 0 : _a.filter(x => x.name !== 'param')),
            parameters
        };
    }
}
 ...
 *--------------------------------------------------------------------------------------------*/
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const mutex_1 = __webpack_require__(115);
const typeConverters = __importStar(__webpack_require__(82));
function wait(ms) {
    return new Promise(resolve => {
        setTimeout(() => {
...
class UpdateImportsOnFileRenameHandler {
    ...
    async promptUser(newResource) {
        return await coc_nvim_1.window.showPrompt(`Update imports for moved file: ${newResource.fsPath}?`);
    }
...
const coc_nvim_1 = __webpack_require__(1);
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const typeconverts = __importStar(__webpack_require__(82));
...
const path_1 = __importDefault(__webpack_require__(13));
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const fileSchemes = __importStar(__webpack_require__(118));
const callbackMap_1 = __webpack_require__(119);
const bufferSyncSupport_1 = __importDefault(__webpack_require__(121));
const diagnostics_1 = __webpack_require__(125);
const fileConfigurationManager_1 = __importDefault(__webpack_require__(35));
const requestQueue_1 = __webpack_require__(126);
const typescriptService_1 = __webpack_require__(120);
const api_1 = __importDefault(__webpack_require__(36));
const configuration_1 = __webpack_require__(127);
const logger_1 = __importDefault(__webpack_require__(132));
const process_1 = __webpack_require__(134);
const tracer_1 = __importDefault(__webpack_require__(135));
const tsconfig_1 = __webpack_require__(136);
const versionProvider_1 = __webpack_require__(137);
const versionStatus_1 = __importDefault(__webpack_require__(138));
const wireProtocol_1 = __webpack_require__(139);
...
class TypeScriptServiceClient {
    ...
    ensureServiceStarted() {
        if (!this.servicePromise) {
            this.startService().catch(err => {
                coc_nvim_1.window.showMessage(`TSServer start failed: ${err.message}`, 'error');
    ...
    async startService(resendModels = false) {
        ...
        if (!currentVersion || !currentVersion.isValid) {
            if (this.configuration.globalTsdk) {
                coc_nvim_1.window.showMessage(`Can not find typescript module, in 'tsserver.tsdk': ${this.configuration.globalTsdk}`, 'error');
            }
            else {
                coc_nvim_1.window.showMessage(`Can not find typescript module, run ':CocInstall coc-tsserver' to fix it!`, 'error');
            }
            return;
        }
            ...
            try {
                process_1.fork(currentVersion.tsServerPath, args, options, this.logger, (err, childProcess) => {
                    ...
                    handle.onError((err) => {
                        ...
                        coc_nvim_1.window.showMessage(`TSServer errored with error. ${err.message}`, 'error');
    ...
    async openTsServerLogFile() {
        ...
        let echoErr = (msg) => {
            coc_nvim_1.window.showMessage(msg, 'error');
        };
        if (isRoot) {
        ...
        if (restart) {
            ...
            if (this.numberRestarts > 5) {
                ...
                if (diff < 10 * 1000 /* 10 seconds */) {
                    this.lastStart = Date.now();
                    startService = false;
                    coc_nvim_1.window.showMessage('The TypeScript language service died 5 times right after it got started.', 'error'); // tslint:disable-line
                }
                else if (diff < 60 * 1000 /* 1 Minutes */) {
                    this.lastStart = Date.now();
                    coc_nvim_1.window.showMessage('The TypeScript language service died unexpectedly 5 times in the last 5 Minutes.', 'error'); // tslint:disable-line
                }
            }
            if (startService) {
...
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const api_1 = __importDefault(__webpack_require__(36));
const async_1 = __webpack_require__(122);
const typeConverters = __importStar(__webpack_require__(82));
const languageModeIds_1 = __webpack_require__(123);
...
const coc_nvim_1 = __webpack_require__(1);
const which_1 = __importDefault(__webpack_require__(128));
...
const isexe = __webpack_require__(129)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const coc_nvim_1 = __webpack_require__(1);
const is = __importStar(__webpack_require__(133));
class Logger {
    get output() {
        if (this._channel) {
            return this._channel;
        }
        this._channel = coc_nvim_1.window.createOutputChannel('tsserver');
        return this._channel;
    }
    dispose() {
        if (this._channel) {
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
const child_process_1 = __importDefault(__webpack_require__(104));
...
class TypeScriptVersionProvider {
    ...
    get bundledVersion() {
        try {
            ...
            coc_nvim_1.window.showMessage('Bundled typescript module not found', 'error');
            return null;
        }
    }
}
...
class VersionStatus {
    constructor(_normalizePath, enableJavascript) {
        ...
        this._versionBarEntry = coc_nvim_1.window.createStatusBarItem(99);
...
class AtaProgressReporter {
    constructor(client) {
        ...
        this._invalid = false;
        this.statusItem = coc_nvim_1.window.createStatusBarItem(10, { progress: true });
        const disposables = [];
    ...
    onTypesInstallerInitializationFailed() {
        this.statusItem.hide();
        if (!this._invalid) {
            coc_nvim_1.window.showMessage('Could not install typings files for JavaScript language features. Please ensure that NPM is installed', 'error');
        }
        this._invalid = true;
    }
}
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
const languageModeIds = __importStar(__webpack_require__(123));
...
const coc_nvim_1 = __webpack_require__(1);
const arrays = __importStar(__webpack_require__(34));
const vscode_languageserver_protocol_1 = __webpack_require__(3);
