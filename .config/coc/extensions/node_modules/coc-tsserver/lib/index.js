...
const path_1 = __importDefault(__webpack_require__(13));
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const callbackMap_1 = __webpack_require__(117);
const bufferSyncSupport_1 = __importDefault(__webpack_require__(119));
const diagnostics_1 = __webpack_require__(122);
const fileConfigurationManager_1 = __importDefault(__webpack_require__(115));
const requestQueue_1 = __webpack_require__(123);
const typescriptService_1 = __webpack_require__(118);
const api_1 = __importDefault(__webpack_require__(40));
    ...
    sendPendingDiagnostics() {
        ...
        if (this.pendingGetErr) {
            ...
            for (const file of this.pendingGetErr.files) {
                let resource = coc_nvim_1.Uri.file(file).toString();
        ...
        if (orderedFileSet.size) {
            let files = Array.from(orderedFileSet.keys).map(uri => this.client.normalizePath(coc_nvim_1.Uri.parse(uri)));
