...
const languageDescription_1 = __webpack_require__(113);
...
const fileConfigurationManager_1 = __importDefault(__webpack_require__(115));
const typescriptServiceClient_1 = __importDefault(__webpack_require__(116));
const typeConverters = __importStar(__webpack_require__(37));
const typingsStatus_1 = __importStar(__webpack_require__(138));
const arrays_1 = __webpack_require__(91);
const watchBuild_1 = __importDefault(__webpack_require__(139));
const workspaceSymbols_1 = __importDefault(__webpack_require__(140));
...
class TypeScriptServiceClientHost {
    ...
    findLanguage(uri) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                let doc = yield coc_nvim_1.workspace.loadFile(uri);
                if (!doc)
                    return undefined;
    ...
    diagnosticsReceived(kind, resource, diagnostics) {
        return __awaiter(this, void 0, void 0, function* () {
            const language = yield this.findLanguage(resource.toString());
            if (language) {
...
class TypeScriptCompletionItemProvider {
    ...
    provideCompletionItems(document, position, token, context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.client.interruptGetErr(() => this.fileConfigurationManager.ensureConfigurationForDocument(document, token));
    ...
    doFormat(document, options, args, token) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.enabled(document))
                return [];
            yield this.formattingOptionsManager.ensureConfigurationOptions(document, options.insertSpaces, options.tabSize, token);
            try {
...
class TypeScriptImplementationsCodeLensProvider extends baseCodeLensProvider_1.TypeScriptBaseCodeLensProvider {
    resolveCodeLens(codeLens, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const response = yield this.client.execute('implementation', args, token, { lowPriority: true });
                if (response && response.type == 'response' && response.body) {
...
class ApplyFixAllCodeAction {
    ...
    execute(document, file, tsAction) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!tsAction.fixId) {
                return;
            }
            yield this.formattingConfigurationManager.ensureConfigurationForDocument(document, vscode_languageserver_protocol_1.CancellationToken.None);
            const args = {
                scope: {
                    type: 'file',
                    args: { file }
...
class TypeScriptQuickFixProvider {
    ...
    provideCodeActions(document, _range, context, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.formattingConfigurationManager.ensureConfigurationForDocument(document, token);
...
class TypeScriptRefactorProvider {
    ...
    provideCodeActions(document, range, context, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!file)
                return undefined;
            yield this.formattingOptionsManager.ensureConfigurationForDocument(document, token);
...
class TypeScriptRenameProvider {
    ...
    execRename(document, position, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.fileConfigurationManager.ensureConfigurationForDocument(document, token);
...
class UpdateImportsOnFileRenameHandler {
    ...
    getEditsForFileRename(document, oldFile, newFile) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.fileConfigurationManager.ensureConfigurationForDocument(document, vscode_languageserver_protocol_1.CancellationToken.None);
...
class OrganizeImportsCommand {
    ...
    getTextEdits(client, document) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const response = yield client.interruptGetErr(() => client.execute('organizeImports', args, vscode_languageserver_protocol_1.CancellationToken.None));
    ...
    execute(document) {
        return __awaiter(this, void 0, void 0, function* () {
            let client = yield this.service.getClientHost();
            if (!document) {
            ...
            let edit = yield this.getTextEdits(client.serviceClient, document);
            if (edit)
                yield coc_nvim_1.workspace.applyEdit(edit);
            return;
        });
...
class OrganizeImportsCodeActionProvider {
    ...
    provideCodeActions(document, _range, context, token) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.fileConfigManager.ensureConfigurationForDocument(document, token);
 ...
 *  Licensed under the MIT License. See License.txt in the project root for license information.
 *--------------------------------------------------------------------------------------------*/
const languageModeIds = __importStar(__webpack_require__(114));
...
class FileConfigurationManager {
    ...
    ensureConfigurationOptions(document, insertSpaces, tabSize, token) {
        return __awaiter(this, void 0, void 0, function* () {
            const file = this.client.toPath(document.uri);
            let options = {
                tabSize,
            ...
            try {
                const response = yield this.client.execute('configure', args, token);
                if (response.type !== 'response') {
    ...
    ensureConfigurationForDocument(document, token) {
        return __awaiter(this, void 0, void 0, function* () {
...
const path_1 = __importDefault(__webpack_require__(13));
const vscode_languageserver_protocol_1 = __webpack_require__(3);
const fileSchemes = __importStar(__webpack_require__(117));
const callbackMap_1 = __webpack_require__(118);
const bufferSyncSupport_1 = __importDefault(__webpack_require__(120));
const diagnostics_1 = __webpack_require__(123);
const fileConfigurationManager_1 = __importDefault(__webpack_require__(115));
const requestQueue_1 = __webpack_require__(124);
const typescriptService_1 = __webpack_require__(119);
const api_1 = __importDefault(__webpack_require__(40));
const configuration_1 = __webpack_require__(125);
const logger_1 = __importDefault(__webpack_require__(130));
const process_1 = __webpack_require__(132);
const tracer_1 = __importDefault(__webpack_require__(133));
const tsconfig_1 = __webpack_require__(134);
const versionProvider_1 = __webpack_require__(135);
const versionStatus_1 = __importDefault(__webpack_require__(136));
const wireProtocol_1 = __webpack_require__(137);
...
const typeConverters = __importStar(__webpack_require__(37));
const languageModeIds_1 = __webpack_require__(114);
const resourceMap_1 = __webpack_require__(122);
...
const coc_nvim_1 = __webpack_require__(1);
const which_1 = __importDefault(__webpack_require__(126));
...
const isexe = __webpack_require__(127)
...
Object.defineProperty(exports, "__esModule", { value: true });
const coc_nvim_1 = __webpack_require__(1);
const is = __importStar(__webpack_require__(131));
class Logger {
    get output() {
        if (this._channel) {
...
class WatchProject {
    constructor(client) {
        ...
        this.disposables.push(coc_nvim_1.commands.registerCommand(WatchProject.id, () => __awaiter(this, void 0, void 0, function* () {
...
class TypeScriptGoToProjectConfigCommand {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield goToProjectConfig(client, doc.uri);
        });
    }
}
...
class AutoFixCommand {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let handles = yield client.handles(document.textDocument);
            if (!handles) {
            ...
            for (let diagnostic of diagnostics) {
                const args = Object.assign(Object.assign({}, typeConverters.Range.toFileRangeRequestArgs(file, diagnostic.range)), { errorCodes: [+(diagnostic.code)] });
                const response = yield client.serviceClient.execute('getCodeFixes', args, vscode_languageserver_protocol_1.CancellationToken.None);
